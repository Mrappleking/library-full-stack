...
-- ===== 6. Books (20种) =====
INSERT INTO books (id, isbn, title, author, publisher, year, total, available, status, clcNumber, physicalDesc, language, country, categoryId, `desc`, created_at, updated_at) VALUES
-- 计算机科学 (cat=1)
(1,  '978-7-111-58444-5', '算法导论',             'Thomas H. Cormen',  '机械工业出版社',   2013, 5, 0, 'available', 'TP301.6',  '780页', 'chi', 'CN', 1, '算法导论 — Thomas H. Cormen 著', NOW(), NOW()),
(2,  '978-7-111-52944-6', '深入理解计算机系统',     'Randal E. Bryant',  '机械工业出版社',   2016, 3, 3, 'available', 'TP303',    '737页', 'chi', 'CN', 1, '深入理解计算机系统 — Randal E. Bryant 著', NOW(), NOW()),
(3,  '978-7-302-57486-0', '机器学习',              '周志华',            '清华大学出版社',   2016, 3, 2, 'available', 'TP181',    '425页', 'chi', 'CN', 1, '机器学习 — 周志华 著', NOW(), NOW()),
(4,  '978-7-121-41559-1', 'Python深度学习',        'François Chollet',  '电子工业出版社',   2022, 3, 3, 'available', 'TP311.56', '481页', 'chi', 'CN', 1, 'Python深度学习 — François Chollet 著', NOW(), NOW()),
(5,  '978-7-115-60960-1', '计算机网络：自顶向下',   'James Kurose',      '人民邮电出版社',   2022, 3, 2, 'available', 'TP393',    '684页', 'chi', 'CN', 1, '计算机网络：自顶向下 — James Kurose 著', NOW(), NOW()),
(6,  '0-201-61586-X',     'Computer Networks',     'Andrew Tanenbaum',  'Prentice Hall',    2017, 3, 3, 'available', 'TP393',    '960pp', 'eng', 'US', 1, 'Computer Networks — Andrew Tanenbaum 著', NOW(), NOW()),
-- 文学小说 (cat=2)
(7,  '978-7-02-000220-7', '红楼梦',                '曹雪芹',            '人民文学出版社',   1996, 4, 3, 'available', 'I242.4',   '1606页','chi', 'CN', 2, '红楼梦 — 曹雪芹 著', NOW(), NOW()),
(8,  '978-7-5447-4254-2', '百年孤独',              '加西亚·马尔克斯',    '南海出版公司',     2011, 3, 3, 'available', 'I775.45',  '360页', 'chi', 'CN', 2, '百年孤独 — 加西亚·马尔克斯 著', NOW(), NOW()),
(9,  '978-7-5063-5020-8', '平凡的世界',            '路遥',              '作家出版社',       2012, 3, 3, 'available', 'I247.5',   '1296页','chi', 'CN', 2, '平凡的世界 — 路遥 著', NOW(), NOW()),
(10, '978-7-5404-7062-5', '活着',                  '余华',              '湖南文艺出版社',   2017, 3, 3, 'available', 'I247.57',  '191页', 'chi', 'CN', 2, '活着 — 余华 著', NOW(), NOW()),
-- 自然科学 (cat=3)
(11, '978-7-301-27701-2', '时间简史',              '史蒂芬·霍金',       '北京大学出版社',   1998, 3, 2, 'available', 'P159-49',  '212页', 'chi', 'CN', 3, '时间简史 — 史蒂芬·霍金 著', NOW(), NOW()),
(12, '978-7-5536-4786-9', '上帝掷骰子吗',          '曹天元',            '浙江教育出版社',   2018, 3, 3, 'available', 'O413-49',  '420页', 'chi', 'CN', 3, '上帝掷骰子吗 — 曹天元 著', NOW(), NOW()),
(13, '978-7-302-57834-0', '从一到无穷大',          '乔治·伽莫夫',       '清华大学出版社',   2020, 3, 3, 'available', 'N49',      '328页', 'chi', 'CN', 3, '从一到无穷大 — 乔治·伽莫夫 著', NOW(), NOW()),
-- 历史哲学 (cat=4)
(14, '978-7-108-04436-5', '万历十五年',            '黄仁宇',            '生活·读书·新知三联书店', 1997, 3, 3, 'available', 'K248.307', '386页', 'chi', 'CN', 4, '万历十五年 — 黄仁宇 著', NOW(), NOW()),
(15, '978-7-220-10795-7', '人类简史',              '尤瓦尔·赫拉利',     '四川人民出版社',   2021, 3, 2, 'available', 'K02-49',   '440页', 'chi', 'CN', 4, '人类简史 — 尤瓦尔·赫拉利 著', NOW(), NOW()),
(16, '978-7-108-06904-7', '中国哲学简史',          '冯友兰',            '生活·读书·新知三联书店', 2019, 3, 3, 'available', 'B2',       '416页', 'chi', 'CN', 4, '中国哲学简史 — 冯友兰 著', NOW(), NOW()),
-- 经济管理 (cat=5)
(17, '978-7-5086-5191-5', '从0到1',                '彼得·蒂尔',         '中信出版社',       2015, 3, 3, 'available', 'F272',     '260页', 'chi', 'CN', 5, '从0到1 — 彼得·蒂尔 著', NOW(), NOW()),
(18, '978-7-5086-6081-8', '思考，快与慢',          '丹尼尔·卡尼曼',     '中信出版社',       2020, 3, 2, 'available', 'F069.9',   '484页', 'chi', 'CN', 5, '思考，快与慢 — 丹尼尔·卡尼曼 著', NOW(), NOW()),
(19, '978-7-5049-9117-9', '国富论',                '亚当·斯密',         '中国人民大学出版社',2021, 3, 3, 'available', 'F091.33',  '540页', 'chi', 'CN', 5, '国富论 — 亚当·斯密 著', NOW(), NOW()),
(20, '978-4-00-331041-5', 'PHP是世界上最好的语言',  '佚名',              '技术出版社',       2024, 3, 3, 'available', 'TP312',    '200页', 'jpn', 'JP', 1, 'PHP是世界上最好的语言 — 佚名 著', NOW(), NOW());
